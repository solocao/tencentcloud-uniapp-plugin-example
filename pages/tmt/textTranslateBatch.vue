...
export default {
  data() {
    return {
      ...
      textArr: [
        {
          sourceText: '机器翻译（Tencent Machine Translation）是腾讯公司研发的人工智能机器翻译产品，基于自研的神经网络翻译引擎，能够从海量语料库中自主学习，在翻译的全过程中整体建模，从而达到翻译结果的高准确率与流畅度',
          result: ''
        },
        {
          sourceText: '机器翻译目前支持 15 个语种，83 种语言对的翻译能力，其中中英互译引擎已经在新闻、教育和部分科技领域达到业界领先水平',
          result: ''
        },
        {
          sourceText: '机器翻译提供中文、英文、日语、韩语、德语、法语、西班牙语、意大利语、土耳其语、俄语、葡萄牙语、越南语、印尼语、马来语、泰语等15种语言文本的翻译服务',
          result: ''
        }
      ],
      params: {
