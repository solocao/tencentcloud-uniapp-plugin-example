...
export default {
  ...
  fn: {
    // 护照识别（港澳台地区及境外护照）
    handleMLIDPassportOCR: async function () {
      try {
    ...
    // 港澳台来往内地通行证识别
    handleMainlandPermitOCR: async function () {
      try {
        const img = await chooseImage2Base64();
        uni.showLoading({
          mask: true,
    ...
    // 港澳台居住证识别
    handleHmtResidentPermitOCR: async function () {
      try {
        const img = await chooseImage2Base64();
        uni.showLoading({
          mask: true,
    ...
    // 户口本识别
    handleResidenceBookletOCR: async function () {
      try {
        const img = await chooseImage2Base64();
        uni.showLoading({
          mask: true,
    ...
    // 房产证识别
    handlePropOwnerCertOCR: async function () {
      try {
        const img = await chooseImage2Base64();
        uni.showLoading({
          mask: true,
    ...
    // 名片识别
    handleBusinessCardOCR: async function () {
      try {
        const img = await chooseImage2Base64();
        uni.showLoading({
          mask: true,
    ...
    // 营业执照识别
    handleBizLicenseOCR: async function () {
      try {
        const img = await chooseImage2Base64();
        uni.showLoading({
          mask: true,
    ...
    // 银行卡识别
    handleBankCardOCR: async function () {
      try {
        const img = await chooseImage2Base64();
        uni.showLoading({
          mask: true,
    ...
    // 组织机构代码证识别
    handleOrgCodeCertOCR: async function () {
      try {
        const img = await chooseImage2Base64();
        uni.showLoading({
          mask: true,
    ...
    // 事业单位法人证书识别
    handleInstitutionOCR: async function () {
      try {
        const img = await chooseImage2Base64();
        uni.showLoading({
          mask: true,
    ...
    // 不动产权证识别
    handleEstateCertOCR: async function () {
      try {
        const img = await chooseImage2Base64();
        uni.showLoading({
          mask: true,
    ...
    // 企业证照识别
    handleEnterpriseLicenseOCR: async function () {
      try {
        const img = await chooseImage2Base64();
        uni.showLoading({
          mask: true,
    ...
    // 护照识别
    handlePassportOCR: async function () {
      try {
        const img = await chooseImage2Base64();
        uni.showLoading({
          mask: true,
    ...
    // 港澳台通行证识别
    handlePermitOCR: async function () {
      try {
        const img = await chooseImage2Base64();
        uni.showLoading({
          mask: true,
    ...
    // 身份证识别
    handleIDCardOCR: async function (carside) {
      try {
        const img = await chooseImage2Base64();
        uni.showLoading({
          mask: true,
