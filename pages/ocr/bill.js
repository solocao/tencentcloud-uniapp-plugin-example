...
export default {
    ...
    fn: {
        // 增值税发票
        handleVatInvoiceOCR: async function(){
            try {
        ...
        // 运单识别
        handleWaybillOCR: async function(){
            try {
                const img = await chooseImage2Base64();
                uni.showLoading({
                    mask: true,
        ...
        // 金融票据切片识别
        handleFinanBillSliceOCR: async function(){
            try {
                const img = await chooseImage2Base64();
                uni.showLoading({
                    mask: true,
        ...
        // 金融票据整单识别
        handleFinanBillOCR: async function(){
            try {
                const img = await chooseImage2Base64();
                uni.showLoading({
                    mask: true,
        ...
        // 增值税发票（卷票）识别
        handleVatRollInvoiceOCR: async function(){
            try {
                const img = await chooseImage2Base64();
                uni.showLoading({
                    mask: true,
        ...
        // 过路过桥费发票识别
        handleTollInvoiceOCR: async function(){
            try {
                const img = await chooseImage2Base64();
                uni.showLoading({
                    mask: true,
        ...
        // 轮船票识别
        handleShipInvoiceOCR: async function(){
            try {
                const img = await chooseImage2Base64();
                uni.showLoading({
                    mask: true,
        ...
        // 混贴票据识别
        handleMixedInvoiceOCR: async function(){
            try {
                const img = await chooseImage2Base64();
                uni.showLoading({
                    mask: true,
        ...
        // 混贴票据分类
        handleMixedInvoiceDetect: async function(){
            try {
                const img = await chooseImage2Base64();
                uni.showLoading({
                    mask: true,
        ...
        // 通用机打发票识别
        handleInvoiceGeneralOCR: async function(){
            try {
                const img = await chooseImage2Base64();
                uni.showLoading({
                    mask: true,
        ...
        // 汽车票识别
        handleBusInvoiceOCR: async function(){
            try {
                const img = await chooseImage2Base64();
                uni.showLoading({
                    mask: true,
        ...
        // 火车票识别
        handleTrainTicketOCR: async function(){
            try {
                const img = await chooseImage2Base64();
                uni.showLoading({
                    mask: true,
        ...
        // 完税证明识别
        handleDutyPaidProofOCR: async function(){
            try {
                const img = await chooseImage2Base64();
                uni.showLoading({
                    mask: true,
         ...
         // 出租车发票识别
         handleTaxiInvoiceOCR: async function(){
            try {
                const img = await chooseImage2Base64();
                uni.showLoading({
                    mask: true,
        ...
        // 定额发票识别
        handleQuotaInvoiceOCR: async function(){
            try {
                const img = await chooseImage2Base64();
                uni.showLoading({
                    mask: true,
        ...
        // 机票行程单识别
        handleFlightInvoiceOCR: async function(){
            try {
                const img = await chooseImage2Base64();
                uni.showLoading({
                    mask: true,
        ...
        // 购车发票识别
        handleCarInvoiceOCR: async function(){
            try {
                const img = await chooseImage2Base64();
                uni.showLoading({
                    mask: true,
